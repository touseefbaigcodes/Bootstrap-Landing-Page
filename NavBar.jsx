...
export default function NavBar() {
  return (
    ...
    <nav>
      <ul className="nav-ul">
        <li className="li boot-icon mt-0">
          <svg
        ...
        <li className="li">Examples</li>
        <li className="li">Icons</li>
        <li className="li">Themes</li>
        ...
        <li className="li versions">
          <select name="" id="select">
            <option value="">v5.3</option>
            <option value="">v5.2.3</option>
            <option value="">v5.1.2</option>
            <option value="">v5.0.2</option>
            <option value="">
              <p>
